...
//$sql = "UPDATE documents SET title='$title', description='$description', author='$author' WHERE id = '$id' " ;

$query = mysqli_query($conn, " UPDATE `documents` SET `title`= '$title',`description`='$description',`author`='$author' WHERE id = '$id' ");
