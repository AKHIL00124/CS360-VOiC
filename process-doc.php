...
$sql = "INSERT INTO documents (title, description, author, createdOn, todaydate, ChildName, ChildState, Parent1Name, ChildStayPre, Parent1State, CaseDate, CaseState, ChangeState, Parent2Name, CaseStay, Parent2State ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
mysqli_stmt_bind_param($stmt, "ssssssssisssssis", $title, $description, $author, $createdOn, $todaydate, $ChildName, $ChildState, $Parent1Name, $ChildStayPre, $Parent1State, $CaseDate, $CaseState, $ChangeState, $Parent2Name, $CaseStay, $Parent2State);
